...
public interface PedidoDAO extends CrudRepository<Pedido, Integer> {
	...
	// @Query("UPDATE new com.durodecodar.desafioilab.dto.PedidoDTO(pedido.idPedido,
	// pedido.entregadorId, " +
	// " FROM Pedido as pedido INNER JOIN Entregador as entregador on pedido.id =
	// coordenadas.idPedido" +
	// " WHERE pedido.id = :id")
	// public void atribuirEntregadorAoPedido(Integer idPedido, Integer
	// entregadorId);
}
